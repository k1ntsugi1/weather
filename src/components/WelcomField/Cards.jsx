    ...
    return (
        <div className="container-cities">
            <div className="container-img" data-name-city="Москва">
                ...
                <img id="moscow" src={ImgMoscow} alt="ImgMoscow" className="city-img" />
            </div>
            <div className="container-img" data-name-city="Санкт-петербург">
                <div className="backface"></div>
                <img id="saintP" src={ImgSaintP} alt="ImgSaintP" className="city-img" />
                
            </div>
            <div className="container-img" data-name-city="Казань">
                <div className="backface"></div>
                <img id="kazan" src={ImgKazan} alt="ImgKazan" className="city-img" />
               
            </div>
            <div className="container-img" data-name-city="Калининград">
                <div className="backface"></div>
                <img id="kaliningrad" src={ImgKaliningrad} alt="ImgKaliningrad" className="city-img" />
            </div>
            <div className="container-img" data-name-city="Челябинск">
                <div className="backface"></div>
                <img id="chelyabinsk" src={ImgChelyabinsk} alt="ImgChelyabinsk" className="city-img" />
            </div>
            <div className="container-img" data-name-city="Сочи">
                <div className="backface"></div>
                <img id="sochi" src={ImgSochi} alt="ImgSochi" className="city-img" />
            </div>
