    ...
    return (
        <div>
            <Popup contentStyle={{ "position": "absolute", "top": "5%", "left": "5%" }} overlayStyle={{"background": "rgb(0 0 0 / 40%)"}} open={isActive} closeOnDocumentClick onClose={() => dispatch(actions_modalHelper.setUnactiveStatus())}>
                <div className="p-3 border border-3 color-additional bg-main rounded" style={{ "display": "inline-block" }}>
                    ...
                    <Button variant="" className=" mb-1 p-1 border-0" onClick={() => dispatch(actions_modalGeoposition.setUnactiveStatus())}>
                        <span className="text-decoration-underline color-additional">не верно</span>
                    </Button>
                    <Button variant="" className="mb-1 me-1 p-1 border-0 " onClick={() => {
                        ...
                        <span className="text-decoration-underline color-additional">верно</span>
                    </Button>
                </div>
            </Popup>
        </div>
